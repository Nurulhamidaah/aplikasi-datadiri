...
<form action="login.php" method="POST" class="w-25 mx-auto">
    ...
    <input class="form-control" type="text" name="username" placeholder="Ex. nurul" required />
    <br>
    <label>Password</label><br>
    <input class="form-control" type="password" name="password" placeholder="Ex. ----" required />
    <br>
    <input class="form-control btn btn-primary btn-m" type="submit" name="login" value="masuk"/>
</form>
